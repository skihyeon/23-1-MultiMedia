...
vocabulary = {'apple': '사과', 'banana': '바나나', 'cherry': '체리', 'grape': '포도', 'orange': '오렌지', 'peach': '복숭아'}

def generate_question():
    word = random.choice(list(vocabulary.keys()))
    print("Say the translation of '" + word + "' in Korean")
    return word
    ...
    while True:
        ...
        if user_input:
            ...
            if user_input == vocabulary[word]:
                ...
                print("Wrong answer. The correct answer is '" + vocabulary[word] + "'.")
